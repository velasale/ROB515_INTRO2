...
try:
    ...
    print(
        "This computer does not appear to be a PiCar-X system (robot is not present). Shadowing hardware calls with substitute functions")
...
class PicarCamera():
    ...
    def __init__(self):
        self.color_dict = {'red': [0, 4], 'orange': [5, 18], 'yellow': [22, 37], 'green': [42, 85], 'blue': [92, 110],
                           'purple': [115, 165],
                           'red_2': [165,
                                     180]}  # Here is the range of H in the HSV color space represented by the color
